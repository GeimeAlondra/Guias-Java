...
-- Schema puntoVenta
-- -----------------------------------------------------
CREATE SCHEMA IF NOT EXISTS `puntoVenta` DEFAULT CHARACTER SET utf8 COLLATE utf8_spanish2_ci ;
USE `puntoVenta` ;
...
CREATE TABLE IF NOT EXISTS `puntoVenta`.`Articulo` (
  ...
  `precioVenta` DECIMAL(11,2) NULL,
  `stock` INT NOT NULL,
  `descripcion` VARCHAR(255) NULL,
  `imagen` VARCHAR(100) NULL,
  `estado` BIT(1) NULL,
  PRIMARY KEY (`idArticulo`),
  UNIQUE INDEX `Articulocol_UNIQUE` (`nombre` ASC) VISIBLE,
